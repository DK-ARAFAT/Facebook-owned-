...
def menu():
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[31;1m1 \033[0;1m] BA ID FACBOOK')
	print('\033[0;1m[ \033[31;1m2 \033[0;1m] BA ID GROUP ( GROUPS )')
	print('\033[0;1m[ \033[31;1m3 \033[0;1m] FOLLOWERS ID VIP ')
	print('\033[0;1m[ \033[31;1m0 \033[0;1m] LOGOUT')
	xoshnaw = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] HALBZHERA: ')
	if xoshnaw in ['1','01']:
		public()
...
def run():
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[31;1m1 \033[0;1m] PASSWORD NAME\n\033[0;1m[ \033[31;1m2 \033[0;1m] PASSWORD NAME AND RAQAM\n\033[0;1m[ \033[31;1m3 \033[0;1m] All PASSWORD NAME and RAQAM')
...
#---------------------
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[1;91m1 \033[0;1m] BA ( B-API )\n\033[0;1m[ \033[1;91m2 \033[0;1m] BA ( MOBILE )\n\033[0;1m[ \033[1;91m3 \033[0;1m] BA ( FREE )')
	hc = input('\n\033[0;1m[ + \033[0;1m] HALBZHERA: ')
	if hc in ['1','01']:
		method.append('bapi')
	elif hc in ['2','02']:
...
def passwrd():
	...
	print('\n')
	print('\033[0;1m[ \033[31;1m+ \033[0;1m] TAWAW BW....')
